...
type tmdbClient interface {
	SearchMovieCandidatesContext(ctx context.Context, title string, year int) ([]tmdb.SearchMovieResult, error)
	SearchTVCandidatesContext(ctx context.Context, name string, year int) ([]tmdb.SearchTVResult, error)
