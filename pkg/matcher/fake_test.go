...
func newFakeTMDBClient() *fakeTMDBClient {
	...
	f.movieSearches[searchKey("Миньоны", 2015)] = []tmdb.SearchMovieResult{{
		ID: 211672, Title: "Миньоны", OriginalTitle: "Minions",
		ReleaseDate: "2015-06-17", VoteAverage: 6.4, Popularity: 85,
	}}
	f.movieSearches[searchKey("Миньоны", 0)] = f.movieSearches[searchKey("Миньоны", 2015)]
	f.addTV(tmdb.SearchTVResult{
